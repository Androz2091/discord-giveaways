...
- [Replit Database (Quick.Replit) example](https://github.com/Androz2091/discord-giveaways/blob/master/examples/custom-databases/quickreplit.js) ⚠️ Only usable if your bot is hosted on [Replit](https://replit.com/)
