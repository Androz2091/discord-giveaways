...
-   ⚙️ Very customizable! (prize, duration, winners, ignored permissions, bonus entries, drops etc...)
...
-   **options.isDrop**: wheter the giveaway is a drop, or not. Drop means that if the amount of reactions to the giveaway is the same as "winnerCount" then it immediately ends.
